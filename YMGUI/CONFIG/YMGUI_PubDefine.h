...
//===========================================================================
// 虚拟摇杆控件总开关(编译期,可裁减):
//   1 → 编译 WIDGET/YMGUI_Joystick(二维拖动、圆形限位、死区、可选松手回中)
//   0 → 整控件 #if 裁空;库核心不依赖它 → 无悬空符号
//===========================================================================
#ifndef YMGUI_JOYSTICK
#define YMGUI_JOYSTICK 1
#endif
...
//===========================================================================
// 文件对话框总开关(编译期,可裁减):
//   1 -> 编译 WIDGET/YMGUI_FileDialog(OPEN_FILE/SAVE_FILE/SELECT_DIRECTORY,
//        文件系统由回调注入,库本体不依赖 dirent/stat)
//   0 -> 整控件裁空;库核心不依赖它
//===========================================================================
#ifndef YMGUI_FILEDIALOG
#define YMGUI_FILEDIALOG 1
#endif
#if YMGUI_FILEDIALOG && !YMGUI_TREEVIEW
#undef YMGUI_FILEDIALOG
#define YMGUI_FILEDIALOG 0 //FileDialog 复用 TreeView;裁掉 TreeView 时一并裁掉
#endif
