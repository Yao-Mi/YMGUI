...
#
#   编译输出:约定用 -B build/rgb565/project_Demo/<项目名> 配置,产物自然落该目录下。
# ===========================================================================
...
if(WIN32 OR ANDROID)
	...
	if(NOT TARGET SDL2::SDL2 AND DEFINED SDL2_SOURCE_DIR)
	...
	if(NOT TARGET SDL2::SDL2)
		message(FATAL_ERROR "SDL2 target not found; provide -DSDL2_DIR or -DSDL2_SOURCE_DIR")
	endif()
