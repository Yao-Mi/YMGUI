...
# SDL 假 LCD(Linux 开发外壳)。真机移植时换掉这块 flush 实现即可。
find_package(PkgConfig REQUIRED)
pkg_check_modules(SDL2 REQUIRED sdl2)
add_library(sdl_lcd STATIC ${YMGUI_SDLDIR}/SDL_LCD.c)
target_include_directories(sdl_lcd PRIVATE ${SDL2_INCLUDE_DIRS})

# ymgui_add_app(<名字> <源文件...>):建一个链好 ymgui + sdl_lcd + SDL2 的可执行
function(ymgui_add_app APP_NAME)
	add_executable(${APP_NAME} ${ARGN})
	target_include_directories(${APP_NAME} PRIVATE ${SDL2_INCLUDE_DIRS})
	target_link_libraries(${APP_NAME} ymgui sdl_lcd ${SDL2_LIBRARIES} m)
endfunction()
